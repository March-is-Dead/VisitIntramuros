...
public class MainAppScreen extends JPanel {
    ...
    private JButton makeTopBtn(String text, boolean accent) {
        ...
        if (accent) {
            btn.setBackground(new Color(200, 169, 110, 40));
            btn.setForeground(GOLD);
            btn.setBorder(BorderFactory.createLineBorder(new Color(200, 169, 110, 80), 1, true));
        } else {
            btn.setBackground(new Color(255, 255, 255, 20));
            btn.setForeground(CREAM_FAINT);
            btn.setBorder(BorderFactory.createLineBorder(new Color(255, 255, 255, 40), 1, true));
        }
        btn.setOpaque(true);
        return btn;
    }
    ...
    private JPanel buildSidebar() {
        ...
        resetBtn.setBackground(new Color(255, 255, 255, 13));
    ...
    private JPanel buildToolbar() {
        ...
        navBtn.setBackground(DARK_GREEN);
    ...
    private JPanel buildInfoPanel() {
        ...
        // Image buttons — clicking opens a popup showing the actual landmark photo
        JPanel media = new JPanel(new FlowLayout(FlowLayout.LEFT, 6, 0));
        media.setOpaque(false);
        media.setBorder(BorderFactory.createEmptyBorder(6, 0, 0, 0));
        for (int i = 0; i < 2; i++) {
            JButton imgBtn = new JButton("🖼  Image " + (i + 1));
            imgBtn.setFont(new Font("SansSerif", Font.PLAIN, 11));
            imgBtn.setBackground(new Color(240, 237, 230));
        ...
        JLabel mediaLabel = new JLabel("Image content");
        mediaLabel.setFont(new Font("SansSerif", Font.ITALIC, 10));
        mediaLabel.setForeground(new Color(160, 150, 130));
        media.add(mediaLabel);
